...
public interface NodeBoundServiceKey<T extends Service> extends ServiceKey<T> {
     ...
     */
    static <S extends Service, R extends Service> NodeBoundServiceKey.Mapped<S, R> mapped(Class<R> serviceClass, ServiceKey<S> key, BiFunction<String, S, R> function) {
        return new NodeBoundServiceKey.Mapped<>(serviceClass, key, function);
    }
